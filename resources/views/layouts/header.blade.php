        ...
        <nav style="margin: 0;padding:0;" class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="tt-noty" style="margin-left: 20px; position: relative;">
                    <a href="javascript:void(0);"><i style="color: white;" class="fa fa-bell-o fa-lg"
                ...
                @if(isset($notifications) && $notifications->count() > 0)
                    <div class="mess-noty"
                         style="display: none; position: absolute;background: white;right: -200px;top: 35px;box-shadow: 1px 0px 10px 3px rgb(0 0 0 / 38%);z-index: 1;">
