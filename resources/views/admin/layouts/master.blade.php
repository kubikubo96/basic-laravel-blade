                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt=""
                                                src="admin_asset/layouts/layout/img/avatar3.jpg" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt=""
                                                src="admin_asset/layouts/layout/img/avatar2.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
...
<![endif]-->
    ...
    <script src="admin_asset/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript">
    </script>
    <!-- END CORE PLUGINS -->
    {{--start: datatable--}}
    <!-- BEGIN PAGE LEVEL PLUGINS !-->
    ...
    <script src="admin_asset/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript">
    </script>
    <!-- END PAGE LEVEL PLUGINS -->
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="admin_asset/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript">
    </script>
    <script src="admin_asset/global/plugins/jquery-multi-select/js/jquery.multi-select.js" type="text/javascript">
    </script>
